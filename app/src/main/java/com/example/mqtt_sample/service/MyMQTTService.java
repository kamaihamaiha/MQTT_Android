package com.example.mqtt_sample.service;
...
public class MyMQTTService extends Service {
    ...
    public String HOST = "tcp://101.133.161.31:1883";//服务器地址（协议+地址+端口号）
    public String USERNAME = "admin";//用户名x
    ...
    private void init() {
        ...
        CLIENTID = "lens_ckf2U8TaobNHq0BR80c0onqUWkr";
